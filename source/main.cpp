...
private:
	...
	void createGraphicsPipeline() {
		auto vertShaderCode = readFile("./resources/shader.vert");
		auto fragShaderCode = readFile("./resources/shader.frag");
	...
	void createComputePipeline() {
		auto computeShaderCode = readFile("./resources/shader.comp");
